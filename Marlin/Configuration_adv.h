...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH 3         // Initial retract in mm
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 1       // Load filament length over hotend in mm
