...
#define STRING_CONFIG_H_AUTHOR "(Remy)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "prusai3"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "4f61ce14-479c-4dec-a81a-e9871ab1f01a"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D "ATC Semitec 104-GT2"
  //#define DEFAULT_Kp 23.09
  //#define DEFAULT_Ki 4.08
  //#define DEFAULT_Kd 32.63
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 224.09
  #define DEFAULT_bedKi 29.39
  #define DEFAULT_bedKd 427.17
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 36 //MIN_PROBE_EDGE
  #define RIGHT_PROBE_BED_POSITION 240 //(X_BED_SIZE - MIN_PROBE_EDGE)
  #define FRONT_PROBE_BED_POSITION 5//MIN_PROBE_EDGE
  #define BACK_PROBE_BED_POSITION 205//(Y_BED_SIZE - MIN_PROBE_EDGE)
